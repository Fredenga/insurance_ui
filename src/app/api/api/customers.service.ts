...
export class CustomersService {
  ...
  public apiCustomersIdDelete(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling apiCustomersIdDelete.'
      );
    }
    ...
    let localVarPath = `/api/Customers/${this.configuration.encodeParam({
      name: 'id',
      value: id,
      in: 'path',
      style: 'simple',
  ...
  public apiCustomersIdPut(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling apiCustomersIdPut.'
      );
    }
